...
| `unit/policy/` | committed policy regression: hostile lists, compatibility catalog, protected tiers, group mapping | A3 |
| `data/` | `compatibility.yaml` catalog (required endpoints, must-stay-blockable names, watch list) | A3 |
