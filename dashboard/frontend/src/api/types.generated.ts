...
export interface paths {
    ...
    "/api/v1/anomalies/{anomaly_id}": {
        ...
        /** Get Anomaly */
        get: operations["get_anomaly_api_v1_anomalies__anomaly_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/devices/{device_id}/anomalies": {
        ...
        /** Device Anomalies */
        get: operations["device_anomalies_api_v1_devices__device_id__anomalies_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        /**
         * AnomalyView
         * @description A persisted, already-evaluated DNS anomaly event — deliberately separate from
...
export interface operations {
    ...
    anomalies_api_v1_anomalies_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AnomalyView"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_anomaly_api_v1_anomalies__anomaly_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    device_anomalies_api_v1_devices__device_id__anomalies_get: {
        parameters: {
            query?: {
                limit?: number;
            };
