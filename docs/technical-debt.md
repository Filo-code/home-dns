...
| TD-004 | 2026-09-13 | Artifact store keeps every activated artifact (~4–5 MB each) | Unbounded disk growth if updates are scheduled | Retention/cleanup is A4 scope; activation is manual and development-only until then | A4 (before any scheduled job) |
