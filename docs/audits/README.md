...
| Stage C lab installation: Pi-hole v6 (not a passive audit — see scope note) | [2026-09-15-stage-c-pihole-lab.md](2026-09-15-stage-c-pihole-lab.md) | ✅ Pi-hole installed and verified. Unbound not yet installed — pending owner approval |
