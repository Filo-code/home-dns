...
| Fastweb Box Seven network audit (B2, gates G3–G5) | [fastweb-seven-b2-checklist.md](fastweb-seven-b2-checklist.md) | ⏳ Checklist written, not yet performed: Box Seven not yet active |
